...
class OverallBookingScreen extends StatelessWidget {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: Obx(() {
            return CustomAppBar(
              title: isSearching.value ? '' : 'Overall Booking Report',
            ...
            Expanded(
              child: Obx(() {
                ...
                if (controller.filteredPayments.isEmpty) {
                  return const Center(
                      child:
                          Text('No payments found with the current filters.'));
                }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                      columns: const [
                        ...
                        DataColumn(label: Text('Additional Discount')),
                      ...
                      rows: controller.filteredPayments.map((payment) {
                        return DataRow(cells: [
                          ...
                          DataCell(Text(payment.staffTips?.isNotEmpty == true
                          ...
                          DataCell(
                              Text('₹${payment.taxAmount?.toString() ?? '0'}')),
                          DataCell(Text('₹${payment.tips?.toString() ?? '0'}')),
                          DataCell(Text(
                              ...
                              children: [
                                if (payment.invoicePdfUrl != null)
                                  GestureDetector(
                                    ...
                                    onTap: () {
                                      String pdfUrl =
                                          '${Apis.pdfUrl}${payment.invoicePdfUrl}';
            ...
            Obx(() => Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('₹${controller.grandTotal.value.toStringAsFixed(2)}',
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 16.sp)),
                    ],
                  ),
  ...
  void _showPaymentMethodDialog(
      BuildContext context, OverallBookingController controller) {
    showDialog(
      context: context,
  ...
  // Helper widget for export options
